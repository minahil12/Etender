...
const headerHeight = useHeaderHeight()
  ...
  keyboardVerticalOffset = {headerHeight + 20} // adjust the value here if you need more padding
  style = {{ flex: 0 }}
  behavior = "padding" >
...
import axios from 'axios';
import { Formik } from 'formik';
import { View, Text, StyleSheet, TextInput, TouchableOpacity,KeyboardAvoidingView,Image,ScrollView ,Alert} from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage'
...
var STORAGE_KEY = 'id_token';
  ...
  useEffect(() => {
    const loggedInUser = AsyncStorage.getItem("email");
